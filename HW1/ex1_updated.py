...
class HarryPotterProblem(search.Problem):
    def _init_(self, initial):
        ...
        search.Problem._init_(self, self.convert_to_state(initial))
    ...
    def h(self, node):
        ...
        # Adjusted coefficients to prioritize horcrux destruction and timely movement towards Voldemort
        return total_distance + 150 * len(horcruxes) + 30 * node.state[5] + 30 * harry_distance_voldemort

    def manhattan_distance(self, start, end):
        """
        Calculate the Manhattan distance between start and end, ignoring obstacles.
        """
        sx, sy = start
        ex, ey = end
