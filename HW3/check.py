...
from Other_Tests.inputs_op_tests import inputs as op_inputs
from Other_Tests.inputs_not_op_tests import inputs as not_op_inputs
from Other_Tests.large_inputs_tests import large_inputs
from inputs import inputs as input2
...
def main():
    ...
    inputs = input2 + op_inputs + not_op_inputs + large_inputs
